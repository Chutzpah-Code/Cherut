...
const values = ['Ownership over permission-asking', 'Craft over speed for its own sake', 'Honesty over comfortable ambiguity', 'Long-term thinking over short-term wins'];
...
export default function CareersPage() {
  ...
  return (
    <PageShell kicker="Careers" title="Come build the future of intentional living" lead="No open roles right now — but we always want to hear from exceptional people.">
      <style>{`
          ...
          <div className="ca-section">
            ...
            {submitted ? (
              <div className="ca-form ca-success">
                ...
                <div style={{ fontSize: 20, fontWeight: 700, color: TEXT, marginBottom: 8 }}>Got it — thank you!</div>
                <p style={{ fontSize: 15, color: MUTED, margin: 0, maxWidth: 360, marginLeft: 'auto', marginRight: 'auto' }}>We'll reach out when something that fits opens up.</p>
              </div>
            ) : (
              <form className="ca-form" onSubmit={handleSubmit}>
                ...
                <div><button type="submit" className="ca-submit">Send introduction →</button></div>
              </form>
            )}
          </div>
        </div>
