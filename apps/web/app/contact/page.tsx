          ...
          <div className="ct-grid">
            ...
            <div className="ct-sidebar">
              ...
              <div className="ct-info-card">
                ...
                <a href="https://t.me/+MxfNsOTcN-Y5MmYx" target="_blank" rel="noopener noreferrer" style={{ fontSize: 14, fontWeight: 600, color: BLUE, padding: '10px 16px', background: BLUE_SOFT, borderRadius: 999, display: 'inline-block' }}>
                  Open community →
                </a>
              </div>
            </div>
