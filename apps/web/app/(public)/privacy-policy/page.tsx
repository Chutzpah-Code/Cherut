  ...
  return (
    <PageShell kicker="Privacy" title="Your privacy is not a footnote." lead="Plain language. No surprises. Last updated May 2026.">
      <style>{`
        ...
        .pp-item { display: flex; gap: 10px; font-size: 15px; color: rgba(237,238,246,0.72); line-height: 1.55; }
        .pp-bullet { color: ${ACCENT}; font-weight: 700; flex-shrink: 0; margin-top: 2px; }
        .pp-notice { background: ${ACCENT_DIM}; border: 1px solid rgba(80,110,255,0.25); border-radius: 12px; padding: 18px 20px; font-size: 14px; color: rgba(237,238,246,0.6); line-height: 1.55; text-align: center; }
